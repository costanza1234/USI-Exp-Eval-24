...
\section{Method}
    ...
    \begin{itemize}
        ...
        \begin{itemize}
            \item Level of sortedness of the input data: random, reversed, first-k-sorted, last-k-sorted with k = half of the size of the array.
    ...
    \begin{enumerate}
        ...
        \begin{itemize}
            ...
            \begin{itemize}
                ...
                \item \textbf{First-k-sorted}: Sort the first half of the array, with the remaining elements randomized.
                \item \textbf{Last-k-sorted}: Sort the last half of the array, with the initial elements randomized.
            \end{itemize}
        \end{itemize}
